...
if (argv.version) {
    console.log("ts-node --max-old-space-size=10240 v" + index_1.VERSION);
    console.log("node --max-old-space-size=10240 " + process.version);
...
if (isEvalScript) {
    ...
    if (stop < process.argv.length) {
        ...
        process.argv = ['node --max-old-space-size=10240'].concat(args);
