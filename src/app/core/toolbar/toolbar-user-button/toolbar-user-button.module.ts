...
import { DialogUserPerfilModule } from './dialog-user-perfil/dialog-user-perfil.module';
import { DialogChangePasswordModule } from './dialog-change-password/dialog-change-password.module';
