...
import { ALL_IN_ONE_TABLE_DEMO_DATA } from './menu.demo';
import { MenuUpdateComponent } from './customer-create-update/customer-create-update.component';
...
export class MenuComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  columns: ListColumn[] = [
    ...
    { name: 'ID', property: 'name', visible: true, isModelProperty: true },
  ...
  createCustomer() {
    this.dialog.open(MenuUpdateComponent).afterClosed().subscribe((customer: Customer) => {
      /**
